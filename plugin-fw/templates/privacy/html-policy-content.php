...
<?php do_action('evdpl_plugin_fw_privacy_guide_content_before'); ?>

    <?php
    foreach ($sections as $key => $section) {
        $privacy_action = "evdpl_plugin_fw_privacy_guide_content_{$key}";
        $content = apply_filters('evdpl_plugin_fw_privacy_guide_content', '', $key);
    ...
    <?php do_action('evdpl_plugin_fw_privacy_guide_content_after'); ?>
</div>
