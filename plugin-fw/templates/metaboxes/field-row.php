...
$extra_row_classes = apply_filters('evdpl_plugin_fw_metabox_extra_row_classes', $extra_row_classes, $field);
$extra_row_classes = is_array($extra_row_classes) ? implode(' ', $extra_row_classes) : '';
?>
<div id="<?php echo esc_attr($field['id']); ?>-container" <?php echo evdpl_field_deps_data($field); ?> class="evdpl-plugin-fw-metabox-field-row <?php echo esc_attr($extra_row_classes); ?>">
