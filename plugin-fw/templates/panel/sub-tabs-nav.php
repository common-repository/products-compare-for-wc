...
<?php if (!empty($sub_tabs)) : ?>
    <div class="evdpl-plugin-fw-sub-tabs-nav">
        <h3 class="nav-tab-wrapper evdpl-nav-sub-tab-wrapper">
            <?php foreach ($sub_tabs as $_key => $_tab) : ?>
                ...
                ?>
                <a href="<?php echo esc_url($_tab->url); ?>" class="evdpl-nav-sub-tab nav-tab <?php echo esc_attr($_tab->class); ?>">
                    <span class="evdpl-nav-sub-tab__title"><?php echo esc_html($_tab->title); ?></span>
                    <?php if ($_tab->icon) : ?>
                        <span class="evdpl-nav-sub-tab__icon evdpl-icon evdpl-icon-<?php echo esc_attr($_tab->icon); ?>"></span>
                    <?php endif; ?>
                </a>
            <?php endforeach; ?>
        </h3>
