...
list ( $field_id, $class, $name, $value, $custom_attributes, $data ) = evdpl_plugin_fw_extract($field, 'id', 'class', 'name', 'value', 'custom_attributes', 'data');
...
?>
<div class="editor <?php echo esc_attr($class); ?>" <?php echo $custom_attributes; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped  ?> <?php echo isset($data) ? evdpl_plugin_fw_html_data_to_string($data) : ''; ?> ><?php wp_editor($value, $field_id, $editor_args); ?></div>
