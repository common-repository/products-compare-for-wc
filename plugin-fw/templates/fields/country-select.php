...
list ( $field_id, $name, $class, $placeholder, $std, $value, $data, $custom_attributes ) = evdpl_plugin_fw_extract($field, 'id', 'name', 'class', 'placeholder', 'std', 'value', 'data', 'custom_attributes');
