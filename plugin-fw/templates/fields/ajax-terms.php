...
evdpl_plugin_fw_enqueue_enhanced_select();

$default_field = array(
    'id' => '',
    'name' => '',
    'class' => 'evdpl-term-search',
    'no_value' => false,
    'multiple' => false,
    'data' => array(),
    'style' => 'width:400px',
...
list ( $field_id, $class, $no_value, $multiple, $data, $name, $style, $value ) = evdpl_plugin_fw_extract($field, 'id', 'class', 'no_value', 'multiple', 'data', 'name', 'style', 'value');
...
$default_data = array(
    ...
    'placeholder' => __('Search Categories', 'evdpl-plugin-fw'),
    'allow_clear' => false,
    'taxonomy' => 'category',
    'term_field' => 'id',
);
...
?>
<div class="evdpl-plugin-fw-select2-wrapper">
    <?php
    if (function_exists('evdpl_add_select2_fields')) {
        evdpl_add_select2_fields(
                array(
                    'id' => $field_id,
                    'name' => $name,
                    'class' => $class,
