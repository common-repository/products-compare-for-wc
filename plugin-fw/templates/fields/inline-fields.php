...
list ( $field_id, $name, $class, $fields, $value ) = evdpl_plugin_fw_extract($field, 'id', 'name', 'class', 'fields', 'value');
...
<?php if (!empty($fields) && is_array($fields)) : ?>
    <div id="<?php echo esc_attr($field_id); ?>" class="<?php echo esc_attr($class); ?> evdpl-inline-fields">
        <?php foreach ($fields as $key => $inline_field) : ?>
            ...
            <div class="option-element <?php echo esc_attr($inline_field['type']); ?> <?php echo esc_attr($inline_field['class']); ?>">
                ...
                <?php endif; ?>
                <?php evdpl_plugin_fw_get_field($inline_field, true); ?>
            </div>
        <?php endforeach; ?>
    </div>
<?php endif; ?>
