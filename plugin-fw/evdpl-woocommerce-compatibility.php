...
if (!function_exists('evdpl_get_prop')) {
     ...
     */
    function evdpl_get_prop($object, $key, $single = true, $context = 'view') {
        $prop_map = evdpl_return_new_attribute_map();
        ...
        if ($is_wc_data) {
            ...
            if (isset($object->$key)) {
                return $object->$key;
            } elseif (evdpl_wc_check_post_columns($key)) {
...
if (!function_exists('evdpl_set_prop')) {
     ...
     *
     */
    function evdpl_set_prop($object, $arg1, $arg2 = false) {
        if (!is_array($arg1)) {
            $arg1 = array(
                $arg1 => $arg2,
            );
        ...
        foreach ($arg1 as $key => $value) {
            if ($is_wc_data) {
                ...
                if (evdpl_wc_check_post_columns($key)) {
...
if (!function_exists('evdpl_save_prop')) {
     ...
     *
     */
    function evdpl_save_prop($object, $arg1, $arg2 = false, $force_update = false) {
        if (!is_array($arg1)) {
            $arg1 = array(
                $arg1 => $arg2,
            );
        ...
        foreach ($arg1 as $key => $value) {
            evdpl_set_prop($object, $key, $value);

            if (!$is_wc_data) {

                if (evdpl_wc_check_post_columns($key)) {
                    evdpl_store_changes($object->post, $key, $value);
                } else {
                    $object_id = is_callable(array($object, 'get_id')) ? $object->get_id() : $object->id;
...
if (!function_exists('evdpl_delete_prop')) {
     ...
     *
     */
    function evdpl_delete_prop($object, $key, $value = '') {
        $prop_map = evdpl_return_new_attribute_map();
        $is_wc_data = $object instanceof WC_Data;
        ...
        if ($is_wc_data) {
            ...
            if (evdpl_wc_check_post_columns($key) && (!$value || $object->post->$key === $value )) {
                evdpl_store_changes($object->post, $key, '');
            } else {
                $object_id = is_callable(array($object, 'get_id')) ? $object->get_id() : $object->id;
...
if (!function_exists('evdpl_return_new_attribute_map')) {
     ...
     * @return string[]
     */
    function evdpl_return_new_attribute_map() {
        return array(
...
if (!function_exists('evdpl_store_changes')) {
     ...
     *
     */
    function evdpl_store_changes($object, $key, $value = false) {
...
if (!function_exists('evdpl_send_changes_to_db')) {

    /**
     * Send changes to DB.
     *
     */
    function evdpl_send_changes_to_db() {
        global $changed_objects;
        ...
        if (!empty($changed_objects)) {
            foreach ($changed_objects as $id => $data) {
                if (version_compare(WC()->version, '2.7.0', '>=')) {
                    ...
                    evdpl_set_prop($object, $data['changes']);
                    $object->save();
                } else {
                    $data['ID'] = $id;
                    wp_update_post($data);
...
if (!function_exists('evdpl_get_orders')) {
     ...
     * @return WC_Order[]
     */
    function evdpl_get_orders($args) {
...
if (!function_exists('evdpl_get_products')) {
     ...
     * @return WC_Product[]
     */
    function evdpl_get_products($args) {
        if (version_compare(WC()->version, '2.7', '<')) {
            $args['fields'] = 'objects';
            $posts = get_posts($args);
...
if (!function_exists('evdpl_update_product_stock')) {
     ...
     */
    function evdpl_update_product_stock($product, $stock_quantity = 1, $operation = 'set') {
...
if (!function_exists('evdpl_wc_deprecated_filters')) {
     ...
     * @return mixed|void
     */
    function evdpl_wc_deprecated_filters() {
        $filters = array(
        ...
        return apply_filters('evdpl_wc_deprecated_filters', $filters);
    }

}

if (!function_exists('evdpl_fix_wc_deprecated_filters')) {

    /**
     * Fix WooCommerce deprecated filters.
     *
     */
    function evdpl_fix_wc_deprecated_filters() {
        if (!version_compare(WC()->version, '2.7.0', '<')) {
            return;
        }

        $deprecated_filters = evdpl_wc_deprecated_filters();
        foreach ($deprecated_filters as $old => $new) {
            add_filter($old, 'evdpl_wc_deprecated_filter_mapping', 10, 100);
        }
    }

}

if (!function_exists('evdpl_wc_deprecated_filter_mapping')) {
     ...
     * @return mixed
     */
    function evdpl_wc_deprecated_filter_mapping() {
        $deprecated_filters = evdpl_wc_deprecated_filters();
...
if (!function_exists('evdpl_wc_check_post_columns')) {
     ...
     * @return bool
     */
    function evdpl_wc_check_post_columns($key) {
        $columns = array(
            'post_author',
            'post_date',
            'post_date_gmt',
...
if (!function_exists('evdpl_get_order_id')) {
     ...
     * @return int
     */
    function evdpl_get_order_id($order) {
        return evdpl_get_prop($order, 'id');
    }

}

if (!function_exists('evdpl_get_product_id')) {
     ...
     * @return mixed
     */
    function evdpl_get_product_id($product) {
        return evdpl_get_prop($product, 'id');
    }

}

if (!function_exists('evdpl_get_base_product_id')) {
     ...
     * @return int
     */
    function evdpl_get_base_product_id($product) {

        return $product instanceof WC_Data && $product->is_type('variation') ?
                evdpl_get_prop($product, 'parent_id') :
                evdpl_get_prop($product, 'id');
    }

}

if (!function_exists('evdpl_get_display_price')) {
     ...
     */
    function evdpl_get_display_price($product, $price = '', $qty = 1) {
        if (version_compare(WC()->version, '2.7.0', '>=')) {
...
if (!function_exists('evdpl_get_price_excluding_tax')) {
     ...
     * @return float|string
     */
    function evdpl_get_price_excluding_tax($product, $qty = 1, $price = '') {
        if (version_compare(WC()->version, '2.7.0', '>=')) {
...
if (!function_exists('evdpl_get_price_including_tax')) {
     ...
     * @return float|string
     */
    function evdpl_get_price_including_tax($product, $qty = 1, $price = '') {
        if (version_compare(WC()->version, '2.7.0', '>=')) {
...
if (!function_exists('evdpl_get_product_image_id')) {
     ...
     * @return mixed
     */
    function evdpl_get_product_image_id($product, $context = 'view') {
        if (version_compare(WC()->version, '2.7.0', '>=')) {
...
if (!function_exists('evdpl_get_refund_amount')) {
     ...
     * @return float
     */
    function evdpl_get_refund_amount($refunded_order, $context = 'view') {
...
if (!function_exists('evdpl_set_refund_amount')) {
     ...
     */
    function evdpl_set_refund_amount($refunded_order, $amount) {
        $is_wc_data = $refunded_order instanceof WC_Data;
...
if (!function_exists('evdpl_get_refund_reason')) {
     ...
     * @return string
     */
    function evdpl_get_refund_reason($refunded_order) {
        $is_wc_data = $refunded_order instanceof WC_Data;
...
if (!function_exists('evdpl_product_visibility_meta')) {
     ...
     * @return array
     */
    function evdpl_product_visibility_meta($args) {
        if (version_compare(WC()->version, '2.7.0', '<')) {
...
if (!function_exists('evdpl_datetime_to_timestamp')) {
     ...
     * @return false|int
     */
    function evdpl_datetime_to_timestamp($date) {
        if (!is_int($date)) {
            $date = strtotime($date);
        }
...
evdpl_fix_wc_deprecated_filters();
add_action('shutdown', 'evdpl_send_changes_to_db');
