...
/**
 * EVDPL Plugin Common Class.
 *
 * @class   EVDPL_Plugin_Common
 * @package EVDPL\PluginFramework\Classes
 */
defined('ABSPATH') || exit; // Exit if accessed directly.

if (!class_exists('EVDPL_Plugin_Common')) {

    /**
     * EVDPL_Plugin_Common class.
     *
     */
    class EVDPL_Plugin_Common {
        ...
        public function init() {
            self::$config['header_backgrounds'] = apply_filters('evdpl_header_backgrounds', self::$config['header_backgrounds']);
            self::$config['body_backgrounds'] = apply_filters('evdpl_body_backgrounds', self::$config['body_backgrounds']);
        }
        ...
        public static function get_icon_list() {
            ...
            return apply_filters('evdpl_icon_list', $standard_icon_list);
        }
