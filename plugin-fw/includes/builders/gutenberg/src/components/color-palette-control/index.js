...
export default function ColorPaletteControl( {
                        ...
                        const id = `inspector-evdpl-color-palette-control-${instanceId}`;
                        return (
                                <BaseControl
    id={id}
    className={`block-editor-evdpl-color-palette-control ${className}`}
    help={help}
    >
    <fieldset>
        <legend>
            <div className="block-editor-evdpl-color-palette-control__color-indicator">
