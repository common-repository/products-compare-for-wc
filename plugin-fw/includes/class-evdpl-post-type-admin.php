 ...
 * Post Type Admin
 *
 * @class   EVDPL_Post_Type_Admin
 * @package EVDPL\PluginFramework\Classes
 */
defined('ABSPATH') || exit; // Exit if accessed directly.

if (!class_exists('EVDPL_Post_Type_Admin')) {

    /**
     * EVDPL_Post_Type_Admin class.
     *
     */
    abstract class EVDPL_Post_Type_Admin {
        ...
        /**
         * EVDPL_Admin_Post_List_Table constructor.
         */
         ...
         * Note: if you use the object, you should set it by overriding the EVDPL_Post_Type_Admin::prepare_row_data method.
         *
         * @return bool
         */
        ...
        protected function should_wp_list_handlers_be_loaded() {
            ...
            if (function_exists('get_current_screen')) {
                ...
                $screen_id = isset($screen, $screen->id) ? esc_attr($screen->id) : '';
            }
         ...
         *
         * @return array{
         * @type string $icon       The EVDPL icon. You can use this one (to use an EVDPL icon) or icon_class or icon_url.
        ...
        protected function get_back_to_wp_list_text() {
            ...
            return !!$name ? sprintf(__('Back to "%s"', 'evdpl-plugin-fw'), $name) : __('Back to the list', 'evdpl-plugin-fw');
        }
        ...
        protected function render_blank_state() {
            ...
            evdpl_plugin_fw_get_component($component, true);
        }
        ...
        public function print_back_to_wp_list_button() {
            ...
            if ($screen_id === $this->post_type) {
                ...
                if ($text) {
                    ?>
                    <div id='evdpl-plugin-fw__back-to-wp-list__wrapper' class='evdpl-plugin-fw__back-to-wp-list__wrapper'>
                        <a id='evdpl-plugin-fw__back-to-wp-list' class='evdpl-plugin-fw__back-to-wp-list' href='<?php echo esc_url($url); ?>'><?php echo esc_html($text); ?></a>
                    </div>
                    <script type="text/javascript">
                        (function () {
                            var wrap = document.querySelector('.wrap'),
                                    backTo = document.querySelector('#evdpl-plugin-fw__back-to-wp-list__wrapper');
